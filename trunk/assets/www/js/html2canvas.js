...
html2canvas.Parse = function (element, images, opts) {
    ...
    function renderText(el, textNode, stack) {
        ...
        stroke_color = getCSS(el, "-webkit-text-stroke-color", false),
        align = false,
        newTextNode,
        textValue,
        textOffset = 0,
        ...
        if (text.length>0){
            ...
            ctx.setVariable("strokeStyle", stroke_color);
                ...
                for (a = 0, storageLen = storageContext.ctx.storage.length; a < storageLen; a+=1){
                    ...
                    switch(renderItem.type){
                        ...
                        case "function":
                            ...
                            }else if(renderItem.name === "strokeText") {
                                // console.log(renderItem.arguments[0]);
                                ctx.strokeText(renderItem['arguments'][0],renderItem['arguments'][1],renderItem['arguments'][2]);
